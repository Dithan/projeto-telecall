      ...
      <div class="painel-content">
        ...
        <table class="adimn-usuarios-table">
          ...
          <tr>
            ...
            <td class="editable" contenteditable="true" data-column="Nome"><?php echo $row['nome']; ?></td>
            <td class="editable" contenteditable="true" data-column="DataNascimento"><?php echo $row['data_nascimento']; ?></td>
            <td class="editable" contenteditable="true" data-column="Sexo"><?php echo $row['sexo']; ?></td>
            <td class="editable" contenteditable="true" data-column="NomeMaterno"><?php echo $row['nome_materno']; ?></td>
            <td class="editable" contenteditable="true" data-column="CPF"><?php echo $row['cpf']; ?></td>
            <td class="editable" contenteditable="true" data-column="Celular"><?php echo $row['telefone_celular']; ?></td>
            <td class="editable" contenteditable="true" data-column="Telefone"><?php echo $row['telefone_fixo']; ?></td>
            <td class="editable" contenteditable="true" data-column="Endereco"><?php echo $row['endereco']; ?></td>
            <td class="editable" contenteditable="true" data-column="Complemento"><?php echo $row['complemento']; ?></td>
            <td class="editable" contenteditable="true" data-column="Login"><?php echo $row['login']; ?></td>
