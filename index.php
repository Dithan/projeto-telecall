...
<body>
    ...
    <section class="cpaas-trans-digital">
        <div class="container">
            <div class="cpaas-trans-digital-lista">
                <h2 class="titulo">CPaaS e a Transformação Digital</h2>
                <ul>
    ...
    <section class="logistica">
        <div class="container">
            <div class="produtos">
                <div class="produto">
                    <h3 class="titulo-blocos">Logística</h3>
                ...
                <div class="produto">
                    <h3 class="titulo-blocos">Varejo</h3>
                ...
                <div class="produto">
                    <h3 class="titulo-blocos">Call Center</h3>
                ...
                <div class="produto">
                    <h3 class="titulo-blocos">Saúde</h3>
                    <p>Acesso seguro com 2FA.</p>
    ...
    <section class="vantagens-telecall-section">
        <div class="container">
            <h2 class="titulo">Vantagens Telecall</h2>
            <div class="vantagens-telecall">
                <div class="part1">
                    <ul class="nomes">
